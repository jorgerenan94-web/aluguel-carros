...
export default function CustomCard({image, cat,model, cambio, pot}){
    return (
        <div className="w-full mx-auto h-auto rounded-lg border border-[#a9a9a9]/50">
            <div className="w-full relative overflow-hidden">
                <img src={image} alt="Fiat Mobi preto" className="w-full h-48 rounded-t-lg hover:scale-110 transition-transform duration-500"/>
